# formkit-select-options Specification

## Purpose
Define the custom FormKit `select` option contract for metadata-rich dropdown rows while preserving existing form value behavior.
