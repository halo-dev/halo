# category-post-navigation Specification

## Purpose
Define the theme Finder and REST API behavior for previous/next post navigation scoped to the current post's primary category.
