# page-layout-contract Specification

## Purpose
Define the standard rendering contract and compatibility reporting for pages that integrate with the active theme layout.
