...
public class FileTypeNotAllowedException extends ResponseStatusException {
    ...
    public FileTypeNotAllowedException(String reason, String messageDetailCode, Object[] messageDetailArguments) {
    ...
    public FileTypeNotAllowedException(
        ...
        super(HttpStatus.UNSUPPORTED_MEDIA_TYPE, reason, cause, messageDetailCode, messageDetailArguments);
    }
}
