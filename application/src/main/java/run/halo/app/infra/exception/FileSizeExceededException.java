...
public class FileSizeExceededException extends ResponseStatusException {
    ...
    public FileSizeExceededException(String reason, String messageDetailCode, Object[] messageDetailArguments) {
    ...
    public FileSizeExceededException(
        ...
        super(HttpStatus.PAYLOAD_TOO_LARGE, reason, cause, messageDetailCode, messageDetailArguments);
    }
}
