...
public class ProxyFilter implements WebFilter {
    ...
    public ProxyFilter(ProxyProperties proxyProperties, String... patterns) {
        ...
        requestMatcher = new AndServerWebExchangeMatcher(
                requestMatcher, new NegatedServerWebExchangeMatcher(new WebSocketServerWebExchangeMatcher()));
        this.requestMatcher = requestMatcher;
        this.webClient = WebClient.create(proxyProperties.getEndpoint().toString());
        log.debug(
                "Initialized ProxyFilter to proxy {} to endpoint {}",
        ...
        return requestMatcher
                ...
                .flatMap(uri -> webClient
                        ...
                        .exchangeToMono(clientResponse -> {
                            ...
                            var contentLength =
                                    clientResponse.headers().contentLength().orElse(0L);
    ...
    private boolean isHtmlRequest(ServerWebExchange exchange) {
        ...
        return acceptHeaders.stream().anyMatch(mediaType -> mediaType.isCompatibleWith(MediaType.TEXT_HTML));
    }
