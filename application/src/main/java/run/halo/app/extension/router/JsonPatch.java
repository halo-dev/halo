...
public final class JsonPatch {
    ...
    public static void addSchema(Components components) {
        ...
        var operationSchema = new io.swagger.v3.oas.models.media.Schema<>()
                .oneOf(List.of(
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "AddOperation"),
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "ReplaceOperation"),
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "TestOperation"),
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "RemoveOperation"),
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "MoveOperation"),
                        new io.swagger.v3.oas.models.media.Schema<>().$ref(COMPONENTS_SCHEMAS_REF + "CopyOperation")));
        ...
        components.addSchemas(
                ...
                new io.swagger.v3.oas.models.media.ObjectSchema()
                        ...
                        .properties(Map.of("op", opSchemaFunc.apply("remove"), "path", pathSchema)));
        components.addSchemas(
                "MoveOperation",
                new io.swagger.v3.oas.models.media.ObjectSchema()
