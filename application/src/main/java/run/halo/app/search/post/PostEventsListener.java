...
public class PostEventsListener {
    ...
    public PostEventsListener(
            ApplicationEventPublisher publisher, PostService postService, ReactiveExtensionClient client) {
        ...
        return client.fetch(Post.class, postName)
                .flatMap(post -> {
                    ...
                    return postService
                            ...
                            .doOnNext(haloDoc ->
                                    publisher.publishEvent(new HaloDocumentAddRequestEvent(this, List.of(haloDoc))));
                })
                .then();
    }

    private void delete(String postName) {
        publisher.publishEvent(new HaloDocumentDeleteRequestEvent(this, List.of(POST_DOCUMENT_TYPE + '-' + postName)));
    }
}
