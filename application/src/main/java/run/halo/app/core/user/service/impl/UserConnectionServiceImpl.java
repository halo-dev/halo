...
public class UserConnectionServiceImpl implements UserConnectionService {
    ...
    public UserConnectionServiceImpl(
            ReactiveExtensionClient client, ApplicationEventPublisher eventPublisher) {
        this.client = client;
    ...
    private Mono<UserConnection> updateUserConnection(
            UserConnection connection, OAuth2User oauth2User) {
                ...
                .doOnNext(
                        deleted ->
                                eventPublisher.publishEvent(
                                        new UserConnectionDisconnectedEvent(this, deleted)));
    }
