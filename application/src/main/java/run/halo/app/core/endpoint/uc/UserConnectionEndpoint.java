                        ...
                        request -> {
                            var removedUserConnections =
                                    ReactiveSecurityContextHolder.getContext()
                                            ...
                                            .flatMapMany(
                                                    username ->
                                                            connectionService.removeUserConnection(
                                                                    request.pathVariable(
                                                                            "registerId"),
                                                                    username));
                            return ServerResponse.ok()
                                    .body(removedUserConnections, UserConnection.class);
                        },
                        builder ->
                                builder.operationId("DisconnectMyConnection")
                                        .description(
                                                "Disconnect my connection from a third-party"
                                                        + " platform.")
                                        .tag(tag)
                                        .parameter(
                                        ...
                                        .response(
                                                responseBuilder()
                                                        .implementationArray(UserConnection.class)))
                .build();
    }
