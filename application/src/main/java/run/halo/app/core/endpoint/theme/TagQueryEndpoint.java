...
public class TagQueryEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                ...
                .GET(
                        ...
                        this::getTagByName,
                        builder ->
                                builder.operationId("queryTagByName")
    ...
    private Mono<ServerResponse> listPostsByTagName(ServerRequest request) {
        ...
        var newFieldSelector =
                listOptions.getFieldSelector().andQuery(Queries.equal("spec.tags", name));
                ...
                .map(
                        result -> {
                            ...
                            return new ListResult<>(
                                    result.getPage(), result.getSize(), result.getTotal(), tagVos);
                        })
                .flatMap(
                        result ->
                                ServerResponse.ok()
