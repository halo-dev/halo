...
/**
 * User preference endpoint for UC (User Center). This endpoint allows users to get and update their preferences by
 * group.
 *
 * @author JohnNiang
 * @since 2.21.0
    ...
    private Mono<Authentication> authenticated() {
        return ReactiveSecurityContextHolder.getContext()
                ...
                .switchIfEmpty(Mono.error(() -> new ResponseStatusException(
                        HttpStatus.FORBIDDEN, "Anonymous user is not allowed to access user preference.")));
    }
