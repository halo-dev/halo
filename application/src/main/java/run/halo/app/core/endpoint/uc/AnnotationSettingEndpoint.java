...
class AnnotationSettingEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                .GET(
                        ...
                        builder ->
                                builder.operationId("listAvailableAnnotationSettings")
                                        .description(
                                                """
                                        ...
                                        .parameter(
                                                parameterBuilder()
                                                        ...
                                                        .description(
                                                                "The targetRef of the"
                                                                    + " AnnotationSetting. e.g.:"
                                                                    + " 'content.halo.run/Post")
                                                        .required(true)
    ...
    private Mono<ServerResponse> listAvailableAnnotationSettings(ServerRequest serverRequest) {
        var targetRef =
                serverRequest.queryParam("targetRef").filter(StringUtils::hasText).orElse(null);
        if (targetRef == null) {
