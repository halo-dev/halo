...
public class PluginEndpoint implements CustomEndpoint, InitializingBean {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                .POST(
                        ...
                        this::install,
                        builder ->
                                builder.operationId("InstallPlugin")
                ...
                .POST(
                        ...
                        this::installFromUri,
                        builder ->
                                builder.operationId("InstallPluginFromUri")
                ...
                .POST(
                        ...
                        this::upgradeFromUri,
                        builder ->
                                builder.operationId("UpgradePluginFromUri")
                ...
                .POST(
                        ...
                        this::upgrade,
                        builder ->
                                builder.operationId("UpgradePlugin")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("updatePluginJsonConfig")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("ResetPluginConfig")
                ...
                .PUT(
                        ...
                        this::reload,
                        builder ->
                                builder.operationId("reloadPlugin")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("ChangePluginRunningState")
                                        .description(
                        ...
                        builder -> {
                            builder.operationId("ListPlugins")
                                    ...
                                    .response(
                                            responseBuilder()
                                                    .implementation(
                                                            generateGenericClass(Plugin.class)));
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchPluginSetting")
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchPluginJsonConfig")
                                        .description(
                                                "Fetch converted json config of plugin by"
                                                        + " configured configMapName.")
                                        .tag(tag)
                                        .parameter(
                                                parameterBuilder()
                                                        .name("name")
                ...
                .GET(
                        ...
                        this::fetchJsBundle,
                        builder ->
                                builder.operationId("fetchJsBundle")
                                        .description(
                ...
                .GET(
                        ...
                        this::fetchCssBundle,
                        builder ->
                                builder.operationId("fetchCssBundle")
                                        .description(
                                                "Merge all CSS bundles of enabled plugins into"
                                                        + " one.")
                                        .tag(tag)
                                        .response(responseBuilder().implementation(String.class)))
                .build();
                        ...
                        plugin -> {
                            ...
                            if (!StringUtils.hasText(configMapName)) {
                                throw new ServerWebInputException(
                                        "Unable to complete the request because the plugin"
                                    ...
                                    .flatMap(
                                            configMapJsonData ->
                                                    settingConfigService.upsertConfig(
                                                            configMapName, configMapJsonData));
                        })
                                        ...
                                        .flatMap(
                                                jsRes -> {
                                                    ...
                                                    return bodyBuilder.body(
                                                            BodyInserters.fromResource(jsRes));
                                                }))
                .orElseGet(
                        () ->
                                pluginService
                                ...
                                pluginService
                                        ...
                                        .flatMap(
                                                cssRes -> {
                                                    ...
                                                    return bodyBuilder.body(
                                                            BodyInserters.fromResource(cssRes));
                                                }))
                .orElseGet(
                        () ->
                                pluginService
    ...
    private Mono<ServerResponse> installFromUri(ServerRequest request) {
        ...
        return Mono.usingWhen(
                        writeToTempFile(content), pluginService::install, this::deleteFileIfExists)
                                    ...
                                    .doOnNext(
                                            configMapToUpdate -> {
                                                ...
                                                if (!configMapName.equals(configMapNameToUpdate)) {
                                                    throw new ServerWebInputException(
                                                            "The name from the request body does"
                                                                    + " not match the plugin"
                                                                    + " configMapName name.");
                                                }
                                            })
                                    .flatMap(
    ...
    private Mono<Plugin> installFromFile(
            FilePart filePart, Function<Path, Mono<Plugin>> resourceClosure) {
        return Mono.usingWhen(
                writeToTempFile(filePart.content()), resourceClosure, this::deleteFileIfExists);
    }
    ...
    public static class ListRequest extends SortableRequest {
        ...
        public ListOptions toListOptions() {
            ...
            Optional.ofNullable(queryParams.getFirst("enabled"))
                    ...
                    .ifPresent(
                            enabled -> builder.andQuery(equal("spec.enabled", enabled.toString())));
    ...
    public static class InstallRequest {
        ...
        public Mono<String> getPresetName() {
            ...
            if (part == null) {
                return Mono.error(
                        new ServerWebInputException("Form field presetName is required."));
            }
