...
public class SystemConfigEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                .GET(
                        ...
                        builder ->
                                builder.operationId("getSystemConfigByGroup")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("updateSystemConfigByGroup")
                                        ...
                                        .parameter(
                                                parameterBuilder()
                                                        ...
                                                        .description("Group of the system config"))
                                        .requestBody(
                                                requestBodyBuilder().implementation(Object.class))
                                        .response(
                                                responseBuilder()
                                                        .responseCode(
                                                                String.valueOf(
    ...
    private Mono<ServerResponse> updateConfigByGroup(ServerRequest request) {
        ...
        return request.bodyToMono(ObjectNode.class)
                .flatMap(
                        objectNode ->
                                configurableEnvironmentFetcher
                                        .getConfigMap()
                                        .flatMap(
                                                cm -> {
                                                    if (cm.getData() == null) {
