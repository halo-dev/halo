...
public class CategoryQueryEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                ...
                .GET(
                        ...
                        this::getByName,
                        builder ->
                                builder.operationId("queryCategoryByName")
                                        ...
                                        .parameter(
                                                parameterBuilder()
                                                        ...
                                                        .required(true))
                                        .response(
                                                responseBuilder().implementation(CategoryVo.class)))
                .GET(
                        "categories/{name}/posts",
                        this::listPostsByCategoryName,
                        builder -> {
    ...
    private Mono<ServerResponse> listPostsByCategoryName(ServerRequest request) {
        ...
        var newFieldSelector =
                listOptions.getFieldSelector().andQuery(Queries.equal("spec.categories", name));
