...
public class SinglePageEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchSinglePageHeadContent")
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchSinglePageReleaseContent")
                ...
                .GET(
                        ...
                        this::fetchContent,
                        builder ->
                                builder.operationId("fetchSinglePageContent")
                ...
                .GET(
                        ...
                        this::listSnapshots,
                        builder ->
                                builder.operationId("listSinglePageSnapshots")
                                        ...
                                        .response(
                                                responseBuilder()
                                                        .implementationArray(
                                                                ListedSnapshotDto.class)))
                .POST(
                        "singlepages",
                        this::draftSinglePage,
                        builder ->
                                builder.operationId("DraftSinglePage")
                                                                                ...
                                                                                Builder
                                                                                        ...
                                                                                        .implementation(
                                                                                                SinglePageRequest
                                                                                                        .class))))
                                        .response(
                                                responseBuilder().implementation(SinglePage.class)))
                .PUT(
                        "singlepages/{name}",
                        this::updateSinglePage,
                        builder ->
                                builder.operationId("UpdateDraftSinglePage")
                ...
                .PUT(
                        ...
                        this::updateContent,
                        builder ->
                                builder.operationId("UpdateSinglePageContent")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("revertToSpecifiedSnapshotForSinglePage")
                                        .description(
                                                "Revert to specified snapshot for single page"
                                                        + " content.")
                                        .tag(tag)
                                        .parameter(
                                                parameterBuilder()
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("PublishSinglePage")
                ...
                .DELETE(
                        ...
                        this::deleteContent,
                        builder ->
                                builder.operationId("deleteSinglePageContent")
    ...
    private Mono<ServerResponse> revertToSpecifiedSnapshot(ServerRequest request) {
        ...
        return request.bodyToMono(RevertSnapshotParam.class)
                ...
                .flatMap(
                        param ->
                                singlePageService.revertToSpecifiedSnapshot(
                                        postName, param.snapshotName))
    ...
    Mono<ServerResponse> publishSinglePage(ServerRequest request) {
        String name = request.pathVariable("name");
        boolean asyncPublish = request.queryParam("async").map(Boolean::parseBoolean).orElse(false);
        return Mono.defer(
                        () ->
                                client.get(SinglePage.class, name)
                                        .flatMap(
                                                singlePage -> {
                                                    SinglePage.SinglePageSpec spec =
                                                            singlePage.getSpec();
                                                    spec.setPublish(true);
                                                    if (spec.getHeadSnapshot() == null) {
                                                        spec.setHeadSnapshot(
                                                                spec.getBaseSnapshot());
                                                    }
