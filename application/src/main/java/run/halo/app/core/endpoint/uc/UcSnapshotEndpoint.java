...
public class UcSnapshotEndpoint implements CustomEndpoint {
        ...
        return route().nest(
                        ...
                        () ->
                                route().GET(
                                                ...
                                                this::getSnapshot,
                                                builder ->
                                                        builder.operationId("GetSnapshotForPost")
                                                                .description(
                                                                        "Get snapshot for one"
                                                                                + " post.")
                                                                .parameter(
                                                                        parameterBuilder()
                                                                                .name("name")
    ...
    private Mono<ServerResponse> getSnapshot(ServerRequest request) {
        ...
        var postName =
                request.queryParam("postName")
                        .orElseThrow(
                                () ->
                                        new ServerWebInputException(
                                                "Query parameter postName is required"));
                        ...
                        post ->
                                Mono.defer(
                                        ...
                                        .filter(
                                                snapshot -> {
                                                    var subjectRef =
                                                            snapshot.getSpec().getSubjectRef();
