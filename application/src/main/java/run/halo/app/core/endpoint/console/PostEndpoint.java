...
public class PostEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchPostHeadContent")
                ...
                .GET(
                        ...
                        this::fetchContent,
                        builder ->
                                builder.operationId("fetchPostContent")
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("fetchPostReleaseContent")
                ...
                .GET(
                        ...
                        this::listSnapshots,
                        builder ->
                                builder.operationId("listPostSnapshots")
                ...
                .PUT(
                        ...
                        this::updatePost,
                        builder ->
                                builder.operationId("UpdateDraftPost")
                ...
                .PUT(
                        ...
                        this::updateContent,
                        builder ->
                                builder.operationId("UpdatePostContent")
                ...
                .PUT(
                        ...
                        builder ->
                                builder.operationId("revertToSpecifiedSnapshotForPost")
                                        .description(
                ...
                .PUT(
                        ...
                        this::publishPost,
                        builder ->
                                builder.operationId("PublishPost")
                ...
                .PUT(
                        ...
                        this::unpublishPost,
                        builder ->
                                builder.operationId("UnpublishPost")
                ...
                .PUT(
                        ...
                        this::recyclePost,
                        builder ->
                                builder.operationId("RecyclePost")
                ...
                .DELETE(
                        ...
                        this::deleteContent,
                        builder ->
                                builder.operationId("deletePostContent")
    ...
    private Mono<ServerResponse> revertToSpecifiedSnapshot(ServerRequest request) {
        ...
        return request.bodyToMono(RevertSnapshotParam.class)
                ...
                .flatMap(
                        param ->
                                postService.revertToSpecifiedSnapshot(postName, param.snapshotName))
    ...
    Mono<ServerResponse> publishPost(ServerRequest request) {
        ...
        return Mono.defer(
                        () ->
                                client.get(Post.class, name)
                                        .doOnNext(
                                                post -> {
                                                    var spec = post.getSpec();
                                                    request.queryParam("headSnapshot")
                                                            .ifPresent(spec::setHeadSnapshot);
    ...
    private Mono<Post> awaitPostPublished(String postName) {
        Predicate<Post> schedulePublish =
                post -> {
                                                        ...
                                                        () ->
                                                                new IllegalStateException(
                                                                        "Retry to check post"
                                                                            + " publish status"))))
                .retryWhen(
                        Retry.backoff(maxAttemptsWaitForPublish, Duration.ofMillis(100))
