...
public class UserNotificationPreferencesEndpoint implements CustomEndpoint {
    ...
    private Mono<ServerResponse> saveNotificationPreferences(ServerRequest request) {
        ...
        return request.bodyToMono(ReasonTypeNotifierCollectionRequest.class)
                .flatMap(requestBody -> {
                    ...
                    return userNotificationPreferenceService.getByUser(username).flatMap(preference -> {
                        ...
                        reasonTypNotifiers.forEach(reasonTypeNotifierRequest -> {
                            ...
                            notifierSetting.setNotifiers(notifiers == null ? Set.of() : Set.copyOf(notifiers));
    ...
    private static <T> Map<String, Integer> toNameIndexMap(List<T> collection, Function<T, String> nameGetter) {
    ...
    Mono<ReasonTypeNotifierMatrix> listReasonTypeNotifierMatrix(String username) {
        ...
        return client.listAll(ReasonType.class, listOptions, ExtensionUtil.defaultSort())
                ...
                .collectList()
                .flatMap(reasonTypes -> client.list(NotifierDescriptor.class, null, Comparators.defaultComparator())
                        .map(notifier -> new NotifierInfo(
                    ...
                    return userNotificationPreferenceService
                            ...
                            .doOnNext(preference -> {
                                ...
                                for (ReasonTypeInfo reasonType : reasonTypes) {
                                    ...
                                    var notifierNames = reasonTypeNotifierMap.getNotifiers(reasonType.name());
    ...
    record ReasonTypeInfo(String name, String displayName, String description, Set<String> uiPermissions) {
        ...
        public static ReasonTypeInfo from(ReasonType reasonType) {
            var uiPermissions = Optional.of(MetadataUtil.nullSafeAnnotations(reasonType))
                    ...
                    .map(uiPermissionStr ->
                            JsonUtils.jsonToObject(uiPermissionStr, new TypeReference<Set<String>>() {}))
                    .orElse(Set.of());
