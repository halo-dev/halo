...
public class DefaultNotificationCenter implements NotificationCenter {
                ...
                .map(
                        notificationContent ->
                                NotificationElement.builder()
                                        ...
                                        .notificationRawBody(
                                                defaultString(notificationContent.rawBody()))
                                        .notificationHtmlBody(
                                                defaultString(notificationContent.htmlBody()))
                                        .build());
    }
        ...
        return client.fetch(User.class, subscriber.name())
                .flatMap(
                        user -> {
                            ...
                            notification
                                    .getSpec()
                                    .setTitle(notificationElement.notificationTitle());
                            notification
                                    .getSpec()
                                    .setRawContent(notificationElement.notificationRawBody());
                            notification
                                    .getSpec()
                                    .setHtmlContent(notificationElement.notificationHtmlBody);
    ...
    Mono<NotificationContent> inferenceTemplate(
            Reason reason, Subscriber subscriber, Locale locale) {
