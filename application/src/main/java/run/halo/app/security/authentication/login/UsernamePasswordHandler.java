...
class UsernamePasswordHandler
    ...
    public Mono<Void> onAuthenticationFailure(
        ...
        return loginHandlerEnhancer
                ...
                .then(
                        ignoringMediaTypeAll(APPLICATION_JSON)
                                .matches(exchange)
                                ...
                                .switchIfEmpty(
                                        Mono.defer(
                                                        () -> {
                                                            var location =
                                                                    URI.create(
                                                                            "/login?error&method=local");
                                                            if (exception
                                                                    instanceof DisabledException) {
                                                                location =
                                                                        URI.create(
                                                                                "/login?error=account-disabled&method=local");
                                                            }
                                                            if (exception
                                                                    instanceof
                                                                ...
                                                                location =
                                                                        URI.create(
                                                                                "/login?error=invalid-credential&method=local");
                                                            }
                                                            if (exception
                                                                    instanceof
                                                                ...
                                                                location =
                                                                        URI.create(
                                                                                "/login?error=rate-limit-exceeded&method=local");
                                                            }
    ...
    public Mono<Void> onAuthenticationSuccess(
        ...
        ServerWebExchangeMatcher xhrMatcher =
                exchange -> {
