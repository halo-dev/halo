    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        return ReactiveSecurityContextHolder.getContext()
                ...
                .doOnNext(
                        ...
                        authentication ->
                                exchange.getAttributes().put(PRE_AUTHENTICATION, authentication))
                                                            ...
                                                            return connectionService
                                                                    ...
                                                                    .switchIfEmpty(
                                                                            Mono.defer(
                                                                                    () -> {
                                                                                        // save the
                                                                                        // OAuth2Authentication into session
