...
public class PatAuthenticationManager implements ReactiveAuthenticationManager {
    ...
    public PatAuthenticationManager(
            ReactiveExtensionClient client, ReactiveAuthenticationManager delegate) {
        this.client = client;
        ...
        return client.fetch(PersonalAccessToken.class, patName)
                ...
                .map(
                        pat -> {
                            ...
                            authorities.add(
                                    new SimpleGrantedAuthority(ROLE_PREFIX + ANONYMOUS_ROLE_NAME));
                            authorities.add(
                                    new SimpleGrantedAuthority(
                                            ROLE_PREFIX + AUTHENTICATED_ROLE_NAME));
                            ...
                            return new JwtAuthenticationToken(
                                    jat.getToken(), authorities, jat.getName());
                        });
    }
