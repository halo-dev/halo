...
/**
 * Default authentication entry point. See <a href="https://datatracker.ietf.org/doc/html/rfc7235#section-4.1">
 * https://datatracker.ietf.org/doc/html/rfc7235#section-4.1</a> for more.
 *
 * @author johnniang
 */
public class DefaultServerAuthenticationEntryPoint implements ServerAuthenticationEntryPoint {
    ...
    public DefaultServerAuthenticationEntryPoint(ServerRequestCache serverRequestCache) {
        var entryPoint = new RedirectServerAuthenticationEntryPoint("/login?authentication_required");
    ...
    public Mono<Void> commence(ServerWebExchange exchange, AuthenticationException ex) {
        return xhrMatcher
                ...
                .switchIfEmpty(Mono.defer(
                        () -> this.redirectEntryPoint.commence(exchange, ex).then(Mono.empty())))
