                ...
                RouterFunctions.route()
                        .GET(
                                ...
                                request -> {
                                    ...
                                    var allFormProviders =
                                            authProviders
                                                    .filter(
                                                            ap ->
                                                                    AuthProvider.AuthType.FORM
                                                                            .equals(
                                                                                    ap.getSpec()
                                                                                            .getAuthType()))
                                                    .cache();
                                    ...
                                    var authProvider =
                                            Mono.justOrEmpty(request.queryParam("method"))
                                                    .flatMap(
                                                            method ->
                                                                    allFormProviders
                                                                            .filter(
                        ...
                        .POST(
                                ...
                                request -> {
                                    ...
                                    return authProviderService
                                            ...
                                            .filter(
                                                    ap ->
                                                            !AuthProvider.AuthType.FORM.equals(
                                            ...
                                            .flatMap(
                                                    ap -> {
                                                        var authenticationUrl =
                                                                ap.getSpec().getAuthenticationUrl();
