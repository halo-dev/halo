...
public class DeviceEndpoint implements CustomEndpoint {
                ...
                .GET(
                        ...
                        builder ->
                                builder.operationId("ListDevices")
                                        ...
                                        .response(
                                                responseBuilder()
                                                        .implementationArray(DeviceDto.class)))
                .DELETE(
                        "devices/{deviceId}",
                        this::revokeDevice,
                        builder ->
                                builder.operationId("RevokeDevice")
                        ...
                        principalName -> {
                            ...
                            var sessionMono =
                                    request.exchange()
                                            .getSession()
                                            .doOnNext(
                                                    session -> builder.sessionId(session.getId()));
    ...
    record RequestContext(
            String username, String sessionId, Map<String, ? extends Session> sessionMap) {}
