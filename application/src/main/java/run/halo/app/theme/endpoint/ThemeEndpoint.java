...
public class ThemeEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                .POST(
                        ...
                        this::install,
                        builder -> builder.operationId("InstallTheme")
                ...
                .GET("themes", this::listThemes, builder -> {
                    builder.operationId("ListThemes")
                            ...
                            .tag(tag)
                            .response(responseBuilder().implementation(ListResult.generateGenericClass(Theme.class)));
                        ...
                        .flatMap(themeSetting -> {
                            ...
                            return systemEnvironmentFetcher
                                    ...
                                    .map(configMap -> {
                                        ...
                                        configMap.getData().put(SystemSetting.Theme.GROUP, themeConfigJson);
                                        return configMap;
                                    });
                        })
    ...
    private Mono<ServerResponse> fetchActivatedTheme(ServerRequest request) {
        var activatedTheme = themeService
                .fetchActivatedTheme()
                .switchIfEmpty(Mono.error(() -> new NotFoundException("Activated theme not found or not set")));
