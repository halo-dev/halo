...
public class MigrationEndpoint implements CustomEndpoint {
    ...
    public RouterFunction<ServerResponse> endpoint() {
        ...
        return SpringdocRouteBuilder.route()
                .GET(
                        ...
                        this::getBackups,
                        builder ->
                                builder.operationId("getBackupFiles")
                                        .tag(tag)
                ...
                .POST(
                        ...
                        builder ->
                                builder.tag(tag)
                                        .description(
                                                "Restore backup by uploading file or providing"
                                                        + " download link or backup name.")
    ...
    private Flux<DataBuffer> getContent(RestoreRequest request) {
        ...
        Supplier<Optional<Flux<DataBuffer>>> contentFromBackupName =
                () ->
                        request.getBackupName()
                                .map(
                                        backupName ->
                                                client.get(Backup.class, backupName)
                                                        .flatMap(migrationService::download)
                                                        .flatMapMany(
                                                                resource ->
                                                                        DataBufferUtils.read(
