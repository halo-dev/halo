...
class FileTypeDetectUtilsTest {
    ...
    void detectMimeTypeWithNameTest() throws IOException {
        ...
        assertThat(mimeType).isEqualTo("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet");
        ...
        assertThat(mimeType).isEqualTo("application/vnd.openxmlformats-officedocument.wordprocessingml.document");
