...
class SessionConfigurationTest {
    ...
    void shouldLoadContextIfNoStoreTypeProvided() {
        ...
        contextRunner.run(context -> {
            ...
            assertInstanceOf(
                    ReactiveIndexedSessionRepository.class, context.getBean(ReactiveIndexedSessionRepository.class));
            assertInstanceOf(
    ...
    void shouldFailToLoadContextIfStoreTypeIsInvalid() {
        ...
        contextRunner.run(
                context -> assertInstanceOf(UnsatisfiedDependencyException.class, context.getStartupFailure()));
    }
}
