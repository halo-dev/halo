...
class ExtensionUpdateHandlerTest {
    ...
    void shouldHandleCorrectly() {
        ...
        var serverRequest =
                MockServerRequest.builder().pathVariable("name", "my-fake").body(Mono.just(unstructured));
    ...
    void shouldReturnErrorWhenExtensionNotFound() {
        ...
        verify(client, times(1))
                .update(argThat(extension ->
                        Objects.equals("my-fake", extension.getMetadata().getName())));
