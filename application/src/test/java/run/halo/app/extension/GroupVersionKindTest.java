...
class GroupVersionKindTest {
    ...
    void testFromApiVersionAndKind() {
        record TestCase(
                String apiVersion, String kind, GroupVersionKind expected, Class<? extends Throwable> exception) {}
        ...
        List.of(
                        ...
                        new TestCase("fake.halo.run/v1alpha1/v1alpha2", "Fake", null, IllegalArgumentException.class))
                .forEach(testCase -> {
    ...
    void testGroupVersion() {
        ...
        List.of(
                        new TestCase(new GroupVersionKind("", "v1alpha1", "Fake"), new GroupVersion("", "v1alpha1")),
                        new TestCase(
                                new GroupVersionKind("fake.halo.run", "v1alpha1", "Fake"),
