...
public class ThemeMessageResolverIntegrationTest {
    ...
    void setUp() throws FileNotFoundException, URISyntaxException {
        ...
        when(themeResolver.getTheme(any(ServerWebExchange.class))).thenReturn(Mono.just(createDefaultContext()));
    }
    ...
    void messageResolverForEnLanguageWhenDefaultTheme() {
        webTestClient
                ...
                .isEqualTo("en")
                .xpath("/html/body/div[2]")
                .isEqualTo("Welcome to the index");
    }
    ...
    void shouldUseDefaultWhenLanguageNotSupport() {
        webTestClient
                ...
                .isEqualTo("Title from index.properties")
                .xpath("/html/body/div[1]")
                .isEqualTo("foo")
                .xpath("/html/body/div[2]")
                .isEqualTo("欢迎来到首页");
    ...
    void switchTheme() throws URISyntaxException {
        webTestClient
                ...
                .expectBody()
                .xpath("/html/head/title")
                .isEqualTo("来自 index_zh.properties 的标题")
                .xpath("/html/body/div[1]")
                .isEqualTo("zh")
                .xpath("/html/body/div[2]")
                .isEqualTo("欢迎来到首页");
        ...
        // For other theme
        when(themeResolver.getTheme(any(ServerWebExchange.class))).thenReturn(Mono.just(createOtherContext()));
        webTestClient
                .get()
                .uri("/index?language=zh")
                .exchange()
        ...
        RouterFunction<ServerResponse> routeTestIndex() {
            return RouterFunctions.route(
                    RequestPredicates.GET("/")
                            .or(RequestPredicates.GET("/index"))
