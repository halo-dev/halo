...
class HaloSpringSecurityDialectTest {
    ...
    @Autowired ServerSecurityContextRepository securityContextRepository;

    @Autowired ObjectProvider<MethodSecurityExpressionHandler> expressionHandler;
    ...
    @MethodSource
    void shouldEvaluateSecAuthorizeAttr(
            String name, List<String> authorities, String template, String expected) {
        ...
        context.setVariable(
                SpringSecurityContextUtils.SECURITY_CONTEXT_MODEL_ATTRIBUTE_NAME, securityContext);
