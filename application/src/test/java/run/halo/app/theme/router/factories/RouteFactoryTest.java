...
class RouteFactoryTest extends RouteFactoryTestSuite {
    ...
    void configuredPageSize() {
        ...
        assertThat(
                        routeFactory
                                .configuredPageSize(
                                        environmentFetcher, SystemSetting.Post::getTagPageSize)
                                .block())
        ...
        assertThat(
                        routeFactory
                                .configuredPageSize(
                                        environmentFetcher, SystemSetting.Post::getPostPageSize)
                                .block())
        ...
        assertThat(
                        routeFactory
                                .configuredPageSize(
                                        environmentFetcher, SystemSetting.Post::getCategoryPageSize)
                                .block())
        ...
        assertThat(
                        routeFactory
                                .configuredPageSize(
                                        environmentFetcher, SystemSetting.Post::getArchivePageSize)
                                .block())
        ...
        assertThat(
                        routeFactory
                                .configuredPageSize(
                                        environmentFetcher, SystemSetting.Post::getAuthorPageSize)
                                .block())
