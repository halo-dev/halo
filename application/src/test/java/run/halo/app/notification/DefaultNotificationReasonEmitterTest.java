...
class DefaultNotificationReasonEmitterTest {
    ...
    @InjectMocks private DefaultNotificationReasonEmitter emitter;
    ...
    void testCreateReasonOnEmit() {
        ...
        doAnswer(
                        as -> {
                            ...
                            JSONAssert.assertEquals(
                                    createReasonJson(),
                                    JsonUtils.objectToJson(returnedValue),
                                    true);
        ...
        spyEmitter
                .emit(
                        reasonType.getMetadata().getName(),
                        builder ->
                                builder.attributes(reasonAttributes())
                                        .subject(
                                                Reason.Subject.builder()
                                                        .apiVersion("content.halo.run/v1alpha1")
                                                        .kind("Post")
                                                        .name(
                                                                "5152aea5-c2e8-4717-8bba-2263d46e19d5")
                                                        .title("Hello Halo")
