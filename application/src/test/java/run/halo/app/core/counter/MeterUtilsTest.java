...
class MeterUtilsTest {
    ...
    void isVisitCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        Counter visitCounter = MeterUtils.visitCounter(meterRegistry, "posts.content.halo.run/fake-post");
    ...
    void isUpvoteCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        Counter upvoteCounter = MeterUtils.upvoteCounter(meterRegistry, "posts.content.halo.run/fake-post");
    ...
    void isDownvoteCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        Counter downvoteCounter = MeterUtils.downvoteCounter(meterRegistry, "posts.content.halo.run/fake-post");
    ...
    void isTotalCommentCounter() {
        MeterRegistry meterRegistry = new SimpleMeterRegistry();
        Counter totalCommentCounter = MeterUtils.totalCommentCounter(meterRegistry, "posts.content.halo.run/fake-post");
