...
class ThumbnailServiceImplTest {
    ...
    void generateTest() {
        ...
        var imageHash = Thumbnail.signatureFor(uri.toString());
    ...
    void createTest() throws MalformedURLException {
        ...
        var hash = "eb54ebf527b0b3e1347122b26995155220847da70558f244e92b91e4d31689c1";
        verify(client).create(assertArg(thumb -> {
            JSONAssert.assertEquals("""
                {
                    "spec": {
                        "imageSignature": "%s",
                        "imageUrl": "http://localhost:8090/test.jpg",
                        "size": "M",
