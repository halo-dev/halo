...
class InMemoryReactiveIndexedSessionRepositoryTest {
    ...
    void saveTest() {
        ...
        assertThat(sessionRepository.getIndexSessionIdMap().get(indexKey))
                .isEqualTo(Set.of("fake-session-1"));
    }
    ...
    void saveToUpdateTest() {
        ...
        assertThat(sessionRepository.getIndexSessionIdMap().get(indexKey2))
                .isEqualTo(Set.of("fake-session-1"));
    }
    ...
    InMemoryReactiveIndexedSessionRepository.IndexKey createSession(
        ...
        var indexKey =
                new InMemoryReactiveIndexedSessionRepository.IndexKey(
                ...
                .doOnNext(
                        session -> {
                            session.setAttribute(
                                    indexKey.attributeName(), indexKey.attributeValue());
