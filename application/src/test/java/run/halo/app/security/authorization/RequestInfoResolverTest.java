...
public class RequestInfoResolverTest {
    ...
    public void nonApiRequestInfoTest() {
        ...
        map.put("simple group", new NonApiCase("/apis/group/version/resource/name/subresource", true));
        ...
        map.forEach((k, v) -> {
            ...
            if (requestInfo.isResourceRequest() != v.expected) {
                throw new RuntimeException(
                        String.format("%s: expected %s, actual %s", k, v.expected, requestInfo.isResourceRequest()));
            }
        });
    }
    ...
    void pluginsScopedAndPluginManage() {
        List<CustomSuccessCase> testCases = List.of(
                new CustomSuccessCase(
                        "DELETE",
                        "/apis/api.plugin.halo.run/v1/plugins/other/posts",
                        "delete",
                        "apis",
                        "api.plugin.halo.run",
                        "v1",
                ...
                new CustomSuccessCase(
                        "POST",
                        "/apis/api.plugin.halo.run/v1beta3/plugins/other/posts/bar",
                        "create",
                        "apis",
                        "api.plugin.halo.run",
                        "v1beta3",
        ...
        for (CustomSuccessCase successCase : testCases) {
            var request = method(HttpMethod.valueOf(successCase.method), successCase.url)
                    .build();
            RequestInfo requestInfo = RequestInfoFactory.INSTANCE.newRequestInfo(request);
            assertThat(requestInfo).isNotNull();
        ...
        List<CustomSuccessCase> pluginScopedCases = List.of(
                new CustomSuccessCase(
                        "DELETE",
                        "/apis/api.plugin.halo.run/v1/plugins/other/posts",
                        "delete",
                ...
                new CustomSuccessCase(
                        "POST",
                        "/apis/api.plugin.halo.run/v1/plugins/other/posts/some-name",
                        "create",
                        "apis",
                        "api.plugin.halo.run",
                        "v1",
        ...
        for (CustomSuccessCase pluginScopedCase : pluginScopedCases) {
            var request = method(HttpMethod.valueOf(pluginScopedCase.method), pluginScopedCase.url)
                    .build();
            RequestInfo requestInfo = RequestInfoFactory.INSTANCE.newRequestInfo(request);
            assertThat(requestInfo).isNotNull();
    ...
    private void assertRequestInfoCase(CustomSuccessCase pluginScopedCase, RequestInfo requestInfo) {
        ...
        assertThat(requestInfo.getSubresource()).isEqualTo(pluginScopedCase.expectedSubresource());
        assertThat(requestInfo.getSubName()).isEqualTo(pluginScopedCase.expectedSubName());
    }

    @Test
    public void errorCaseTest() {
        List<ErrorCases> errorCases = List.of(
                new ErrorCases("no resource path", "/"),
        ...
        for (ErrorCases errorCase : errorCases) {
            var request = method(HttpMethod.GET, errorCase.url).build();
            RequestInfo apiRequestInfo = RequestInfoFactory.INSTANCE.newRequestInfo(request);
            if (apiRequestInfo.isResourceRequest()) {
                throw new RuntimeException(String.format("%s: expected non-resource request", errorCase.desc));
            }
        }

        List<ErrorCases> postCases = List.of(
                new ErrorCases("api resource has name and no subresource but post", "/api/version/themes/install"),
                new ErrorCases(
                        "apis resource has name and no subresource but post",
                        "/apis/api.halo.run/v1alpha1/themes/install"));
        for (ErrorCases errorCase : postCases) {
            var request = method(HttpMethod.POST, errorCase.url).build();
            RequestInfo apiRequestInfo = RequestInfoFactory.INSTANCE.newRequestInfo(request);
            if (apiRequestInfo.isResourceRequest()) {
                throw new RuntimeException(String.format("%s: expected non-resource request", errorCase.desc));
            }
    ...
    public record CustomSuccessCase(
            String method,
            String url,
            String expectedVerb,
            String expectedAPIPrefix,
    ...
    List<SuccessCase> getTestRequestInfos() {
        ...
        return List.of(
                new SuccessCase(
                        "GET", "/api/v1/namespaces", "list", "api", "", "v1", "", "namespaces", "", "", new String[] {
                            "namespaces"
                        }),
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other",
                        "get",
                        "api",
                        "",
                        "v1",
                        ...
                        "",
                        "other",
                        new String[] {"namespaces", "other"}),
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts",
                        "list",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts/foo",
                        "get",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        ...
                        new String[] {"posts", "foo"}),
                new SuccessCase(
                        "GET", "/api/v1/posts", "list", "api", "", "v1", namespaceAll, "posts", "", "", new String[] {
                            "posts"
                        }),
                new SuccessCase(
                        "HEAD", "/api/v1/posts", "list", "api", "", "v1", namespaceAll, "posts", "", "", new String[] {
                            "posts"
                        }),
                new SuccessCase(
                        "GET",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/proxy/namespaces/other/posts/foo",
                        "proxy",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/watch/namespaces/other/posts",
                        "watch",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts?watch=true",
                        "watch",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts?watch=false",
                        "list",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts/foo/status",
                        "get",
                        "api",
                        "",
                        "v1",
                        ...
                        "status",
                        "foo",
                        new String[] {"posts", "foo", "status"}),
                new SuccessCase(
                        "GET",
                        "/api/v1/namespaces/other/posts/foo/proxy/subpath",
                        "get",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "DELETE",
                        "/api/v1/namespaces/other/posts?all=true",
                        "deletecollection",
                        "api",
                        "",
                        "v1",
                ...
                new SuccessCase(
                        "DELETE",
                        "/apis/extensions/v1/namespaces/other/posts?all=true",
                        "deletecollection",
                        "apis",
                        "extensions",
                        "v1",
                ...
                new SuccessCase(
                        "POST",
                        "/apis/extensions/v1/namespaces/other/posts",
                        "create",
                        "apis",
                        "extensions",
                        "v1",
                ...
                new SuccessCase(
                        "POST",
                        "/apis/extensions/v1beta3/namespaces/other/posts",
                        "create",
                        "apis",
                        "extensions",
                        "v1beta3",
