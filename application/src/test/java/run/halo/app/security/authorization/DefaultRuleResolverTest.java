...
class DefaultRuleResolverTest {
    ...
    @InjectMocks DefaultRuleResolver ruleResolver;
        ...
        var cases =
                List.of(
                        ...
                        new RequestResolveCase(
                                "/api/v1/userspaces/bar/categories", "DELETE", false),
                        new RequestResolveCase(
                                "/api/v1/userspaces/admin/categories", "DELETE", true),
    ...
    List<RequestResolveCase> getRequestResolveCases() {
        return List.of(
                ...
                new RequestResolveCase(
                        "/apis/api.plugin.halo.run/v1alpha1/plugins/foo/users", "GET", true),
                new RequestResolveCase(
                        "/apis/api.plugin.halo.run/v1alpha1/plugins/foo/users/bar", "GET", true),
                new RequestResolveCase(
                        "/apis/api.plugin.halo.run/v1alpha1/plugins/foo/posts/bar", "GET", false),
