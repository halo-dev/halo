...
class OptionalDependentResolverTest {
    ...
    void testNoPlugins() {
        ...
        assertTrue(
                resolver.getOptionalDependents("nonexistent").isEmpty(),
    ...
    void testSingleOptionalDependency() {
        ...
        OptionalDependentResolver resolver = new OptionalDependentResolver(List.of(pluginA, pluginB));

        assertEquals(List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }

    @Test
    void testMultipleOptionalDependencies() {
        var pluginA = createpluginDescriptor("A", List.of(new PluginDependency("B?"), new PluginDependency("C?")));

        var pluginB = createpluginDescriptor("B", List.of());

        var pluginC = createpluginDescriptor("C", List.of());

        OptionalDependentResolver resolver = new OptionalDependentResolver(List.of(pluginA, pluginB, pluginC));

        assertEquals(List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertEquals(List.of("A"), resolver.getOptionalDependents("C"), "C should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }
    ...
    void testNestedDependencies() {
        var pluginA = createpluginDescriptor("A", List.of(new PluginDependency("B?")));
        var pluginB = createpluginDescriptor("B", List.of(new PluginDependency("C?")));
        var pluginC = createpluginDescriptor("C", List.of());

        OptionalDependentResolver resolver = new OptionalDependentResolver(List.of(pluginA, pluginB, pluginC));

        assertEquals(List.of("B"), resolver.getOptionalDependents("C"), "C should have B as dependent");
        assertEquals(List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }
    ...
    void testCircularDependencies() {
        var pluginA = createpluginDescriptor("A", List.of(new PluginDependency("B?")));
        var pluginB = createpluginDescriptor("B", List.of(new PluginDependency("A?")));
        OptionalDependentResolver resolver = new OptionalDependentResolver(List.of(pluginA, pluginB));

        assertEquals(List.of("B"), resolver.getOptionalDependents("A"), "A should have B as dependent");
        assertEquals(List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
    }
    ...
    PluginDescriptor createpluginDescriptor(String pluginName, List<PluginDependency> dependencies) {
