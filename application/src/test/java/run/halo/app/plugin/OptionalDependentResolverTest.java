...
class OptionalDependentResolverTest {
    ...
    void testSingleOptionalDependency() {
        ...
        assertEquals(
                List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }
    ...
    void testMultipleOptionalDependencies() {
        var pluginA =
                createpluginDescriptor(
                        "A", List.of(new PluginDependency("B?"), new PluginDependency("C?")));
        ...
        assertEquals(
                List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertEquals(
                List.of("A"), resolver.getOptionalDependents("C"), "C should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }
    ...
    void testNestedDependencies() {
        ...
        assertEquals(
                List.of("B"), resolver.getOptionalDependents("C"), "C should have B as dependent");
        assertEquals(
                List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
        assertTrue(resolver.getOptionalDependents("A").isEmpty(), "A has no dependents");
    }
    ...
    void testCircularDependencies() {
        ...
        assertEquals(
                List.of("B"), resolver.getOptionalDependents("A"), "A should have B as dependent");
        assertEquals(
                List.of("A"), resolver.getOptionalDependents("B"), "B should have A as dependent");
    }
    ...
    PluginDescriptor createpluginDescriptor(
            String pluginName, List<PluginDependency> dependencies) {
