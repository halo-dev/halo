...
class DefaultExtensionGetterTest {
    ...
    @Mock ExtensionDefinitionGetter extensionDefinitionGetter;

    @Mock PluginManager pluginManager;

    @Mock SystemConfigFetcher configFetcher;

    @Mock BeanFactory beanFactory;

    @Mock ObjectProvider<FakeExtensionPoint> extensionPointObjectProvider;

    @InjectMocks DefaultExtensionGetter getter;
    ...
    void shouldGetExtensionBySingletonDefinitionWhenExtensionPointEnabledSet() {
        ...
        doReturn(List.of(extensionImpl))
                .when(spyGetter)
    ...
    void shouldGetExtensionsFromPluginManagerAndApplicationContext() {
        ...
        var spyGetter = spy(getter);
        doReturn(List.of(extensionFromPlugin))
                .when(spyGetter)
                .lookExtensions(eq(FakeExtensionPoint.class));
    ...
    ExtensionPointDefinition createExtensionPointDefinition(
            String name, Class<?> clazz, ExtensionPointType type) {
