...
/**
 * Halo OAuth2 authentication token which combines {@link UserDetails} and original {@link OAuth2AuthenticationToken}.
 *
 * @author johnniang
 * @since 2.20.0
 */
public class HaloOAuth2AuthenticationToken extends AbstractAuthenticationToken {
     ...
     */
    public HaloOAuth2AuthenticationToken(UserDetails userDetails, OAuth2AuthenticationToken original) {
    ...
    public Collection<GrantedAuthority> getAuthorities() {
        ...
        var authorities = new ArrayList<GrantedAuthority>(originalAuthorities.size() + userDetailsAuthorities.size());
    ...
    /**
     * Creates an authenticated {@link HaloOAuth2AuthenticationToken} using {@link UserDetails} and original
     * {@link OAuth2AuthenticationToken}.
     *
     * @param userDetails the {@link UserDetails}
     * @param original the original {@link OAuth2AuthenticationToken}
