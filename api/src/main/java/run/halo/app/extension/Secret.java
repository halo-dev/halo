...
public class Secret extends AbstractExtension {
    ...
    /**
     * Used to facilitate programmatic handling of secret data. More info: <a
     * href="https://kubernetes.io/docs/concepts/configuration/secret/#secret-types">secret-types</a>
     */
    private String type;
     ...
     *
     * <p>{@code data} contains the secret data. Each key must consist of alphanumeric characters, '-', '_' or '.'. The
     * serialized form of the secret data is a base64 encoded string, representing the arbitrary (possibly non-string)
     * data value here. Described in <a href="https://tools.ietf.org/html/rfc4648#section-4">rfc4648#section-4</a>
     */
    private Map<String, byte[]> data;

    /**
     * {@code stringData} allows specifying non-binary secret data in string form. It is provided as a write-only input
