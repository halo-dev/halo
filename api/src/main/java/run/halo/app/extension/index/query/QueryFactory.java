...
public class QueryFactory {
    ...
    public static And and(Query left, Query right) {
        Assert.isInstanceOf(
                Condition.class, left, "Only Condition instances are supported in AND operations");
        Assert.isInstanceOf(
                Condition.class, right, "Only Condition instances are supported in AND operations");
    ...
    public static Query not(Query query) {
        Assert.isInstanceOf(
                Condition.class, query, "Only Condition instances are supported in NOT operations");
        return ((Condition) query).not();
    }

    public static Query betweenLowerExclusive(
            String fieldName, String lowerValue, String upperValue) {
        return Queries.between(fieldName, lowerValue, false, upperValue, true);
    }

    public static Query betweenUpperExclusive(
            String fieldName, String lowerValue, String upperValue) {
