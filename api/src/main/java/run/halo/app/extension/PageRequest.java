 ...
 *
 * <p>if page size is 0, it means no pagination and all results will be returned.
 *
 * @author guqing
 * @see PageRequestImpl
 * @since 2.12.0
...
public interface PageRequest {
    ...
    /**
     * Returns the previous {@link PageRequest} or the first {@link PageRequest} if the current one already is the first
     * one.
     *
     * @return a new {@link org.springframework.data.domain.PageRequest} with {@link #getPageNumber()} - 1 as
     *     {@link #getPageNumber()}
     */
