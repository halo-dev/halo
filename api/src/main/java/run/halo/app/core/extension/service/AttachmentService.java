...
public interface AttachmentService {
     ...
     *
     * <p>If no handler can be found to upload the given attachment, ServerError exception will be thrown.
     *
    ...
    /**
     * Uploads the given attachment to specific storage using handlers in plugins. Please note that we will make sure
     * the request is authenticated, or an unauthorized exception throws.
     *
     * <p>If no handler can be found to upload the given attachment, ServerError exception will be thrown.
     *
     * @param policyName is attachment policy name.
     ...
     *
     * <p>If no handler can be found to delete the given attachment, Mono.empty() will return.
     *
     ...
     * @return time-to-live shared URL. Please note that, if the attachment is stored in local, the shared URL is equal
     *     to permalink.
     */
    Mono<URI> getSharedURL(Attachment attachment, Duration ttl);

    /**
     * Gets thumbnail links using handlers in plugins. Please make sure the attachment has permalink.
     *
     * @param attachment is created attachment.
     ...
     * @return attachment
     */
    Mono<Attachment> uploadFromUrl(URL url, String policyName, @Nullable String groupName, @Nullable String filename);
}
