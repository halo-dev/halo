...
import static run.halo.app.core.extension.Role.*;
...
public class Role extends AbstractExtension {
    public static final String ROLE_DEPENDENCY_RULES = "rbac.authorization.halo.run/dependency-rules";
    public static final String ROLE_AGGREGATE_LABEL_PREFIX = "rbac.authorization.halo.run/aggregate-to-";
    ...
    public static final String SYSTEM_RESERVED_LABELS = "rbac.authorization.halo.run/system-reserved";
    ...
    public static final String UI_PERMISSIONS_AGGREGATED_ANNO = "rbac.authorization.halo.run/ui-permissions-aggregated";
    ...
    /**
     * PolicyRule holds information that describes a policy rule, but does not contain information about whom the rule
    ...
    public static class PolicyRule implements Comparable<PolicyRule> {
        ...
        /**
         * Resources is a list of resources this rule applies to. '*' represents all resources in the specified
         * apiGroups. '*&#47;foo' represents the subresource 'foo' for all resources in the specified apiGroups.
         */
        final String[] resources;

        /**
         * ResourceNames is an optional white list of names that the rule applies to. An empty set means that everything
         * is allowed.
         */
