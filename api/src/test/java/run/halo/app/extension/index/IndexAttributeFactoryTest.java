...
class IndexAttributeFactoryTest {
    ...
    void shouldCreateMultiValueAttribute() {
        var attribute = IndexAttributeFactory.multiValueAttribute(FakeExtension.class, FakeExtension::getTags);
        ...
        Assertions.assertEquals(Set.of(new UnknownKey("tag1"), new UnknownKey("tag2")), attribute.getValues(extension));
    }

    @Test
    void shouldCreateSingleValueAttribute() {
        var attribute = IndexAttributeFactory.simpleAttribute(FakeExtension.class, FakeExtension::getName);
        assertThat(attribute).isNotNull();
        assertThat(attribute.getObjectType()).isEqualTo(FakeExtension.class);
        var extension = new FakeExtension();
        extension.setMetadata(new Metadata());
        ...
        Assertions.assertEquals(Set.of(new UnknownKey("Fake Extension Name")), attribute.getValues(extension));
    }

    @Data
    @EqualsAndHashCode(callSuper = true)
    @GVK(group = "test", version = "v1", kind = "FakeExtension", plural = "fakes", singular = "fake")
