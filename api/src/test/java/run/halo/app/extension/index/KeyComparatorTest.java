...
class KeyComparatorTest {
    ...
    void keyComparator() {
        ...
        assertThat(strings)
                .isEqualTo(new String[] {"101", "102", "103", "1011", "1012", "1013", "1021", "1022", "1023"});

        Arrays.sort(strings, comparator.reversed());
        assertThat(strings)
                .isEqualTo(new String[] {"1023", "1022", "1021", "1013", "1012", "1011", "103", "102", "101"});

        // but if we use natural order, the result is:
        Arrays.sort(strings, Comparator.naturalOrder());
        assertThat(strings)
                .isEqualTo(new String[] {"101", "1011", "1012", "1013", "102", "1021", "1022", "1023", "103"});
    }
    ...
    void keyComparator2() {
        ...
        // date sort
        strings = new String[] {"2022-01-15", "2022-02-01", "2021-12-25", "2022-01-01", "2022-01-02"};
        Arrays.sort(strings, comparator);
        assertThat(strings)
                .isEqualTo(new String[] {"2021-12-25", "2022-01-01", "2022-01-02", "2022-01-15", "2022-02-01"});
    ...
    void mixLetterCaseStringTest() {
        var strings = new String[] {
            "VpLBxBJ7", "AJHQ9JKT", "asda", "Tq5EgH2V", "Fh8Jd09T", "J7KMLQeK", "adJhTqEo", "Ahvcq7Wn",
        };
        Arrays.sort(strings, comparator);
        assertThat(strings)
                .containsExactly(
                        "AJHQ9JKT", "Ahvcq7Wn", "Fh8Jd09T", "J7KMLQeK", "Tq5EgH2V", "VpLBxBJ7", "adJhTqEo", "asda");
    }
    ...
    public void sortingWithDecimalStringsTest() {
        List<String> strings = Arrays.asList("1.2", "1.10", "1.1", "1.20", "1.02", "1.22", "1.001", "1.002");
        strings.sort(comparator);
        assertThat(strings).containsExactly("1.001", "1.002", "1.02", "1.1", "1.10", "1.2", "1.20", "1.22");
    }
    ...
    class ComparatorCharacteristicTest {
        ...
        public void consistencyTest() {
            ...
            assertThat(comparator.compare("test", "test")).isZero();
            assertThat(comparator.compare("123abc", "123abc")).isEqualTo(comparator.compare("123abc", "123abc"));
        }
    ...
    class ComparatorEdgeTest {
        ...
        public void mumbersWithOverflowTest() {
            ...
            assertThat(comparator.compare("123456789012345678901234567890", "123456789012345678901234567891"))
                    .isLessThan(0);
            assertThat(comparator.compare("123456789012345678901234567890", "123456789012345678901234567891"))
                    .isNotPositive();
            assertThat(comparator.compare("999999999999999999999999999999", "999999999999999999999999999998"))
                    .isGreaterThan(0);
            assertThat(comparator.compare("999999999999999999999999999999", "999999999999999999999999999998"))
                    .isNotNegative();
            assertThat(comparator.compare(
                    ...
                    .isGreaterThan(0);
            assertThat(comparator.compare("100000000000000000000000000000", "100000000000000000000000000000"))
                    .isEqualTo(0);
