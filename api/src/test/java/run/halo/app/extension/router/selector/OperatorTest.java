...
import static run.halo.app.extension.router.selector.Operator.*;
...
class OperatorTest {
    ...
    void shouldConvertCorrectly() {
        ...
        List.of(
                        ...
                        new TestCase("name=value", Equals, new SelectorCriteria("name", Equals, Set.of("value"))),
                        new TestCase("name=v", Equals, new SelectorCriteria("name", Equals, Set.of("v"))),
                        ...
                        new TestCase(
                                "name!=value", NotEquals, new SelectorCriteria("name", NotEquals, Set.of("value"))),
                        ...
                        new TestCase("name!", NotExist, null),
                        new TestCase("name!=1", NotEquals, new SelectorCriteria("name", NotEquals, Set.of("1"))),
                        new TestCase("name!=12", NotEquals, new SelectorCriteria("name", NotEquals, Set.of("12"))),
                        ...
                        new TestCase("name=(fake-name)", IN, new SelectorCriteria("name", IN, Set.of("fake-name"))),
                        new TestCase(
