...
class SelectorConverterTest {
    ...
    void shouldConvertCorrectly() {
        ...
        List.of(
                        new TestCase("", null),
                        new TestCase("name=value", new SelectorCriteria("name", Equals, Set.of("value"))),
                        new TestCase("name!=value", new SelectorCriteria("name", Operator.NotEquals, Set.of("value"))),
                        new TestCase("name", new SelectorCriteria("name", Operator.Exist, Set.of())),
                        new TestCase("!name", new SelectorCriteria("name", Operator.NotExist, Set.of())),
                        new TestCase("name", new SelectorCriteria("name", Operator.Exist, Set.of())),
                        new TestCase("name!=", new SelectorCriteria("name!=", Operator.Exist, Set.of())),
