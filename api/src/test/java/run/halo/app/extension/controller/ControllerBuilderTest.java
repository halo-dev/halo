...
class ControllerBuilderTest {
    ...
    void invalidMinDelayAndMaxDelay() {
        ...
        assertNotNull(fakeBuilder().minDelay(null).maxDelay(Duration.ofSeconds(1)).build());

        assertNotNull(fakeBuilder().minDelay(Duration.ofSeconds(1)).maxDelay(null).build());
