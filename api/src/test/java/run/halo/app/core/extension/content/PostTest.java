...
class PostTest {
    ...
    static Stream<Arguments> isRecycledProvider() {
        Function<Consumer<Metadata>, Metadata> metadataCreator = metadataConsumer -> {
        ...
        return Stream.of(
                ...
                Arguments.of(
                        metadataCreator.apply(metadata -> metadata.setLabels(Map.of(Post.DELETED_LABEL, "false"))),
                        false),
                Arguments.of(
                        metadataCreator.apply(metadata -> metadata.setLabels(Map.of(Post.DELETED_LABEL, "invalid"))),
                        false),
                Arguments.of(
                        metadataCreator.apply(metadata -> {
