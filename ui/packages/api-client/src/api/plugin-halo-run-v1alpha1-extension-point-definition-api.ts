 ...
 * @export
 */
export const PluginHaloRunV1alpha1ExtensionPointDefinitionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        /**
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/ExtensionPointDefinition
         * @param {string} name Name of extensionpointdefinition
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1ExtensionPointDefinition: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchPluginHaloRunV1alpha1ExtensionPointDefinition', 'name', name)
            const localVarPath = `/apis/plugin.halo.run/v1alpha1/extensionpointdefinitions/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
 ...
 * @export
 */
export const PluginHaloRunV1alpha1ExtensionPointDefinitionApiFp = function(configuration?: Configuration) {
    const localVarAxiosParamCreator = PluginHaloRunV1alpha1ExtensionPointDefinitionApiAxiosParamCreator(configuration)
    return {
        /**
         * Create plugin.halo.run/v1alpha1/ExtensionPointDefinition
         * @param {ExtensionPointDefinition} [extensionPointDefinition] Fresh extensionpointdefinition
         ...
         * @throws {RequiredError}
         */
        async patchPluginHaloRunV1alpha1ExtensionPointDefinition(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtensionPointDefinition>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchPluginHaloRunV1alpha1ExtensionPointDefinition(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PluginHaloRunV1alpha1ExtensionPointDefinitionApi.patchPluginHaloRunV1alpha1ExtensionPointDefinition']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update plugin.halo.run/v1alpha1/ExtensionPointDefinition
 ...
 * @export
 */
export const PluginHaloRunV1alpha1ExtensionPointDefinitionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/ExtensionPointDefinition
         * @param {PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinitionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1ExtensionPointDefinition(requestParameters: PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinitionRequest, options?: RawAxiosRequestConfig): AxiosPromise<ExtensionPointDefinition> {
            return localVarFp.patchPluginHaloRunV1alpha1ExtensionPointDefinition(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update plugin.halo.run/v1alpha1/ExtensionPointDefinition
...
/**
 * Request parameters for patchPluginHaloRunV1alpha1ExtensionPointDefinition operation in PluginHaloRunV1alpha1ExtensionPointDefinitionApi.
 * @export
 * @interface PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinitionRequest
 */
export interface PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinitionRequest {
    /**
     * Name of extensionpointdefinition
     * @type {string}
     * @memberof PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinition
     */
    readonly name: string
...
export class PluginHaloRunV1alpha1ExtensionPointDefinitionApi extends BaseAPI {
     ...
     * @memberof PluginHaloRunV1alpha1ExtensionPointDefinitionApi
     */
    public patchPluginHaloRunV1alpha1ExtensionPointDefinition(requestParameters: PluginHaloRunV1alpha1ExtensionPointDefinitionApiPatchPluginHaloRunV1alpha1ExtensionPointDefinitionRequest, options?: RawAxiosRequestConfig) {
        return PluginHaloRunV1alpha1ExtensionPointDefinitionApiFp(this.configuration).patchPluginHaloRunV1alpha1ExtensionPointDefinition(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
