...
export const NotificationHaloRunV1alpha1SubscriptionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Patch notification.halo.run/v1alpha1/Subscription
         * @param {string} name Name of subscription
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchNotificationHaloRunV1alpha1Subscription: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchNotificationHaloRunV1alpha1Subscription', 'name', name)
            const localVarPath = `/apis/notification.halo.run/v1alpha1/subscriptions/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const NotificationHaloRunV1alpha1SubscriptionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchNotificationHaloRunV1alpha1Subscription(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Subscription>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchNotificationHaloRunV1alpha1Subscription(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['NotificationHaloRunV1alpha1SubscriptionApi.patchNotificationHaloRunV1alpha1Subscription']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update notification.halo.run/v1alpha1/Subscription
...
export const NotificationHaloRunV1alpha1SubscriptionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch notification.halo.run/v1alpha1/Subscription
         * @param {NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1SubscriptionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchNotificationHaloRunV1alpha1Subscription(requestParameters: NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1SubscriptionRequest, options?: RawAxiosRequestConfig): AxiosPromise<Subscription> {
            return localVarFp.patchNotificationHaloRunV1alpha1Subscription(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update notification.halo.run/v1alpha1/Subscription
...
/**
 * Request parameters for patchNotificationHaloRunV1alpha1Subscription operation in NotificationHaloRunV1alpha1SubscriptionApi.
 * @export
 * @interface NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1SubscriptionRequest
 */
export interface NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1SubscriptionRequest {
    /**
     * Name of subscription
     * @type {string}
     * @memberof NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1Subscription
     */
    readonly name: string
...
export class NotificationHaloRunV1alpha1SubscriptionApi extends BaseAPI {
     ...
     * @memberof NotificationHaloRunV1alpha1SubscriptionApi
     */
    public patchNotificationHaloRunV1alpha1Subscription(requestParameters: NotificationHaloRunV1alpha1SubscriptionApiPatchNotificationHaloRunV1alpha1SubscriptionRequest, options?: RawAxiosRequestConfig) {
        return NotificationHaloRunV1alpha1SubscriptionApiFp(this.configuration).patchNotificationHaloRunV1alpha1Subscription(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
