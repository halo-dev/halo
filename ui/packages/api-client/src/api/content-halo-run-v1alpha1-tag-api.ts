...
export const ContentHaloRunV1alpha1TagApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Patch content.halo.run/v1alpha1/Tag
         * @param {string} name Name of tag
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchContentHaloRunV1alpha1Tag: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchContentHaloRunV1alpha1Tag', 'name', name)
            const localVarPath = `/apis/content.halo.run/v1alpha1/tags/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ContentHaloRunV1alpha1TagApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchContentHaloRunV1alpha1Tag(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Tag>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchContentHaloRunV1alpha1Tag(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ContentHaloRunV1alpha1TagApi.patchContentHaloRunV1alpha1Tag']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update content.halo.run/v1alpha1/Tag
...
export const ContentHaloRunV1alpha1TagApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch content.halo.run/v1alpha1/Tag
         * @param {ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1TagRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchContentHaloRunV1alpha1Tag(requestParameters: ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1TagRequest, options?: RawAxiosRequestConfig): AxiosPromise<Tag> {
            return localVarFp.patchContentHaloRunV1alpha1Tag(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update content.halo.run/v1alpha1/Tag
...
/**
 * Request parameters for patchContentHaloRunV1alpha1Tag operation in ContentHaloRunV1alpha1TagApi.
 * @export
 * @interface ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1TagRequest
 */
export interface ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1TagRequest {
    /**
     * Name of tag
     * @type {string}
     * @memberof ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1Tag
     */
    readonly name: string
...
export class ContentHaloRunV1alpha1TagApi extends BaseAPI {
     ...
     * @memberof ContentHaloRunV1alpha1TagApi
     */
    public patchContentHaloRunV1alpha1Tag(requestParameters: ContentHaloRunV1alpha1TagApiPatchContentHaloRunV1alpha1TagRequest, options?: RawAxiosRequestConfig) {
        return ContentHaloRunV1alpha1TagApiFp(this.configuration).patchContentHaloRunV1alpha1Tag(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
