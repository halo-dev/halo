...
export const PluginHaloRunV1alpha1PluginApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/Plugin
         * @param {string} name Name of plugin
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1Plugin: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchPluginHaloRunV1alpha1Plugin', 'name', name)
            const localVarPath = `/apis/plugin.halo.run/v1alpha1/plugins/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const PluginHaloRunV1alpha1PluginApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchPluginHaloRunV1alpha1Plugin(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Plugin>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchPluginHaloRunV1alpha1Plugin(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PluginHaloRunV1alpha1PluginApi.patchPluginHaloRunV1alpha1Plugin']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update plugin.halo.run/v1alpha1/Plugin
...
export const PluginHaloRunV1alpha1PluginApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/Plugin
         * @param {PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1PluginRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1Plugin(requestParameters: PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1PluginRequest, options?: RawAxiosRequestConfig): AxiosPromise<Plugin> {
            return localVarFp.patchPluginHaloRunV1alpha1Plugin(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update plugin.halo.run/v1alpha1/Plugin
...
/**
 * Request parameters for patchPluginHaloRunV1alpha1Plugin operation in PluginHaloRunV1alpha1PluginApi.
 * @export
 * @interface PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1PluginRequest
 */
export interface PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1PluginRequest {
    /**
     * Name of plugin
     * @type {string}
     * @memberof PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1Plugin
     */
    readonly name: string
...
export class PluginHaloRunV1alpha1PluginApi extends BaseAPI {
     ...
     * @memberof PluginHaloRunV1alpha1PluginApi
     */
    public patchPluginHaloRunV1alpha1Plugin(requestParameters: PluginHaloRunV1alpha1PluginApiPatchPluginHaloRunV1alpha1PluginRequest, options?: RawAxiosRequestConfig) {
        return PluginHaloRunV1alpha1PluginApiFp(this.configuration).patchPluginHaloRunV1alpha1Plugin(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
