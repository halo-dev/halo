...
export const PluginHaloRunV1alpha1ExtensionDefinitionApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/ExtensionDefinition
         * @param {string} name Name of extensiondefinition
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1ExtensionDefinition: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchPluginHaloRunV1alpha1ExtensionDefinition', 'name', name)
            const localVarPath = `/apis/plugin.halo.run/v1alpha1/extensiondefinitions/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const PluginHaloRunV1alpha1ExtensionDefinitionApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchPluginHaloRunV1alpha1ExtensionDefinition(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ExtensionDefinition>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchPluginHaloRunV1alpha1ExtensionDefinition(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['PluginHaloRunV1alpha1ExtensionDefinitionApi.patchPluginHaloRunV1alpha1ExtensionDefinition']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update plugin.halo.run/v1alpha1/ExtensionDefinition
...
export const PluginHaloRunV1alpha1ExtensionDefinitionApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch plugin.halo.run/v1alpha1/ExtensionDefinition
         * @param {PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinitionRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchPluginHaloRunV1alpha1ExtensionDefinition(requestParameters: PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinitionRequest, options?: RawAxiosRequestConfig): AxiosPromise<ExtensionDefinition> {
            return localVarFp.patchPluginHaloRunV1alpha1ExtensionDefinition(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update plugin.halo.run/v1alpha1/ExtensionDefinition
...
/**
 * Request parameters for patchPluginHaloRunV1alpha1ExtensionDefinition operation in PluginHaloRunV1alpha1ExtensionDefinitionApi.
 * @export
 * @interface PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinitionRequest
 */
export interface PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinitionRequest {
    /**
     * Name of extensiondefinition
     * @type {string}
     * @memberof PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinition
     */
    readonly name: string
...
export class PluginHaloRunV1alpha1ExtensionDefinitionApi extends BaseAPI {
     ...
     * @memberof PluginHaloRunV1alpha1ExtensionDefinitionApi
     */
    public patchPluginHaloRunV1alpha1ExtensionDefinition(requestParameters: PluginHaloRunV1alpha1ExtensionDefinitionApiPatchPluginHaloRunV1alpha1ExtensionDefinitionRequest, options?: RawAxiosRequestConfig) {
        return PluginHaloRunV1alpha1ExtensionDefinitionApiFp(this.configuration).patchPluginHaloRunV1alpha1ExtensionDefinition(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
