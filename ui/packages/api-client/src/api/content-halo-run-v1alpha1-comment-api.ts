...
export const ContentHaloRunV1alpha1CommentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        /**
         * Patch content.halo.run/v1alpha1/Comment
         * @param {string} name Name of comment
         * @param {Array<JsonPatchInner>} [jsonPatchInner] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchContentHaloRunV1alpha1Comment: async (name: string, jsonPatchInner?: Array<JsonPatchInner>, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'name' is not null or undefined
            assertParamExists('patchContentHaloRunV1alpha1Comment', 'name', name)
            const localVarPath = `/apis/content.halo.run/v1alpha1/comments/{name}`
                .replace(`{${"name"}}`, encodeURIComponent(String(name)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
...
export const ContentHaloRunV1alpha1CommentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async patchContentHaloRunV1alpha1Comment(name: string, jsonPatchInner?: Array<JsonPatchInner>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Comment>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.patchContentHaloRunV1alpha1Comment(name, jsonPatchInner, options);
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['ContentHaloRunV1alpha1CommentApi.patchContentHaloRunV1alpha1Comment']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
        /**
         * Update content.halo.run/v1alpha1/Comment
...
export const ContentHaloRunV1alpha1CommentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        /**
         * Patch content.halo.run/v1alpha1/Comment
         * @param {ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1CommentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        patchContentHaloRunV1alpha1Comment(requestParameters: ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1CommentRequest, options?: RawAxiosRequestConfig): AxiosPromise<Comment> {
            return localVarFp.patchContentHaloRunV1alpha1Comment(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(axios, basePath));
        },
        /**
         * Update content.halo.run/v1alpha1/Comment
...
/**
 * Request parameters for patchContentHaloRunV1alpha1Comment operation in ContentHaloRunV1alpha1CommentApi.
 * @export
 * @interface ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1CommentRequest
 */
export interface ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1CommentRequest {
    /**
     * Name of comment
     * @type {string}
     * @memberof ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1Comment
     */
    readonly name: string
...
export class ContentHaloRunV1alpha1CommentApi extends BaseAPI {
     ...
     * @memberof ContentHaloRunV1alpha1CommentApi
     */
    public patchContentHaloRunV1alpha1Comment(requestParameters: ContentHaloRunV1alpha1CommentApiPatchContentHaloRunV1alpha1CommentRequest, options?: RawAxiosRequestConfig) {
        return ContentHaloRunV1alpha1CommentApiFp(this.configuration).patchContentHaloRunV1alpha1Comment(requestParameters.name, requestParameters.jsonPatchInner, options).then((request) => request(this.axios, this.basePath));
    }
