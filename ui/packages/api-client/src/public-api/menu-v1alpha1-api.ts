...
export const MenuV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async queryMenuByName(name: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MenuVo>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['MenuV1alpha1Api.queryMenuByName']?.[localVarOperationServerIndex]?.url;
        ...
        async queryPrimaryMenu(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MenuVo>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['MenuV1alpha1Api.queryPrimaryMenu']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const MenuV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * Gets menu by name.
         * @param {MenuV1alpha1ApiQueryMenuByNameRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        queryMenuByName(requestParameters: MenuV1alpha1ApiQueryMenuByNameRequest, options?: RawAxiosRequestConfig): AxiosPromise<MenuVo> {
...
/**
 * Request parameters for queryMenuByName operation in MenuV1alpha1Api.
 * @export
 * @interface MenuV1alpha1ApiQueryMenuByNameRequest
 */
export interface MenuV1alpha1ApiQueryMenuByNameRequest {
    /**
     * Menu name
     * @type {string}
     * @memberof MenuV1alpha1ApiQueryMenuByName
     */
...
export class MenuV1alpha1Api extends BaseAPI {
     ...
     */
    public queryMenuByName(requestParameters: MenuV1alpha1ApiQueryMenuByNameRequest, options?: RawAxiosRequestConfig) {
        return MenuV1alpha1ApiFp(this.configuration).queryMenuByName(requestParameters.name, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public queryPrimaryMenu(options?: RawAxiosRequestConfig) {
        return MenuV1alpha1ApiFp(this.configuration).queryPrimaryMenu(options).then((request) => request(this.axios, this.basePath));
    }
}
