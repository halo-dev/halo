...
export const AttachmentV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async searchAttachments(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, ungrouped?: boolean, keyword?: string, accepts?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AttachmentList>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['AttachmentV1alpha1Api.searchAttachments']?.[localVarOperationServerIndex]?.url;
        ...
        async uploadAttachment(file: File, policyName: string, groupName?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Attachment>> {
            ...
            const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
            const localVarOperationServerBasePath = operationServerMap['AttachmentV1alpha1Api.uploadAttachment']?.[localVarOperationServerIndex]?.url;
            return (axios, basePath) => createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration)(axios, localVarOperationServerBasePath || basePath);
        },
    }
};
...
export const AttachmentV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * 
         * @param {AttachmentV1alpha1ApiSearchAttachmentsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        searchAttachments(requestParameters: AttachmentV1alpha1ApiSearchAttachmentsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<AttachmentList> {
        ...
        /**
         * 
         * @param {AttachmentV1alpha1ApiUploadAttachmentRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        uploadAttachment(requestParameters: AttachmentV1alpha1ApiUploadAttachmentRequest, options?: RawAxiosRequestConfig): AxiosPromise<Attachment> {
...
/**
 * Request parameters for searchAttachments operation in AttachmentV1alpha1Api.
 * @export
 * @interface AttachmentV1alpha1ApiSearchAttachmentsRequest
 */
export interface AttachmentV1alpha1ApiSearchAttachmentsRequest {
    /**
     * Page number. Default is 0.
     * @type {number}
     * @memberof AttachmentV1alpha1ApiSearchAttachments
     */
...
/**
 * Request parameters for uploadAttachment operation in AttachmentV1alpha1Api.
 * @export
 * @interface AttachmentV1alpha1ApiUploadAttachmentRequest
 */
export interface AttachmentV1alpha1ApiUploadAttachmentRequest {
    /**
     * 
     * @type {File}
     * @memberof AttachmentV1alpha1ApiUploadAttachment
     */
    readonly file: File
...
export class AttachmentV1alpha1Api extends BaseAPI {
     ...
     * @memberof AttachmentV1alpha1Api
     */
    public uploadAttachment(requestParameters: AttachmentV1alpha1ApiUploadAttachmentRequest, options?: RawAxiosRequestConfig) {
        return AttachmentV1alpha1ApiFp(this.configuration).uploadAttachment(requestParameters.file, requestParameters.policyName, requestParameters.groupName, options).then((request) => request(this.axios, this.basePath));
    }
}
