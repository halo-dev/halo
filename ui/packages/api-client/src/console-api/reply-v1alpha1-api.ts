...
export const ReplyV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async listReplies(commentName: string, page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ListedReplyList>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['ReplyV1alpha1Api.listReplies']?.[localVarOperationServerIndex]?.url;
...
export const ReplyV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * List replies.
         * @param {ReplyV1alpha1ApiListRepliesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listReplies(requestParameters: ReplyV1alpha1ApiListRepliesRequest, options?: RawAxiosRequestConfig): AxiosPromise<ListedReplyList> {
...
/**
 * Request parameters for listReplies operation in ReplyV1alpha1Api.
 * @export
 * @interface ReplyV1alpha1ApiListRepliesRequest
 */
export interface ReplyV1alpha1ApiListRepliesRequest {
    /**
     * Replies filtered by commentName.
     * @type {string}
     * @memberof ReplyV1alpha1ApiListReplies
     */
...
export class ReplyV1alpha1Api extends BaseAPI {
     ...
     */
    public listReplies(requestParameters: ReplyV1alpha1ApiListRepliesRequest, options?: RawAxiosRequestConfig) {
        return ReplyV1alpha1ApiFp(this.configuration).listReplies(requestParameters.commentName, requestParameters.page, requestParameters.size, requestParameters.labelSelector, requestParameters.fieldSelector, requestParameters.sort, options).then((request) => request(this.axios, this.basePath));
    }
}
