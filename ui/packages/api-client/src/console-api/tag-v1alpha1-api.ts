...
export const TagV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async listPostTags(page?: number, size?: number, labelSelector?: Array<string>, fieldSelector?: Array<string>, sort?: Array<string>, keyword?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<TagList>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['TagV1alpha1Api.listPostTags']?.[localVarOperationServerIndex]?.url;
...
export const TagV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * List Post Tags.
         * @param {TagV1alpha1ApiListPostTagsRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listPostTags(requestParameters: TagV1alpha1ApiListPostTagsRequest = {}, options?: RawAxiosRequestConfig): AxiosPromise<TagList> {
...
/**
 * Request parameters for listPostTags operation in TagV1alpha1Api.
 * @export
 * @interface TagV1alpha1ApiListPostTagsRequest
 */
export interface TagV1alpha1ApiListPostTagsRequest {
    /**
     * Page number. Default is 0.
     * @type {number}
     * @memberof TagV1alpha1ApiListPostTags
     */
...
export class TagV1alpha1Api extends BaseAPI {
     ...
     */
    public listPostTags(requestParameters: TagV1alpha1ApiListPostTagsRequest = {}, options?: RawAxiosRequestConfig) {
        return TagV1alpha1ApiFp(this.configuration).listPostTags(requestParameters.page, requestParameters.size, requestParameters.labelSelector, requestParameters.fieldSelector, requestParameters.sort, requestParameters.keyword, options).then((request) => request(this.axios, this.basePath));
    }
}
