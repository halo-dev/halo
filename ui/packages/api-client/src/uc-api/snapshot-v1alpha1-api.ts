...
export const SnapshotV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async getSnapshotForPost(name: string, postName: string, patched?: boolean, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Snapshot>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['SnapshotV1alpha1Api.getSnapshotForPost']?.[localVarOperationServerIndex]?.url;
...
export const SnapshotV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * Get snapshot for one post.
         * @param {SnapshotV1alpha1ApiGetSnapshotForPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getSnapshotForPost(requestParameters: SnapshotV1alpha1ApiGetSnapshotForPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<Snapshot> {
...
/**
 * Request parameters for getSnapshotForPost operation in SnapshotV1alpha1Api.
 * @export
 * @interface SnapshotV1alpha1ApiGetSnapshotForPostRequest
 */
export interface SnapshotV1alpha1ApiGetSnapshotForPostRequest {
    /**
     * Snapshot name.
     * @type {string}
     * @memberof SnapshotV1alpha1ApiGetSnapshotForPost
     */
...
export class SnapshotV1alpha1Api extends BaseAPI {
     ...
     */
    public getSnapshotForPost(requestParameters: SnapshotV1alpha1ApiGetSnapshotForPostRequest, options?: RawAxiosRequestConfig) {
        return SnapshotV1alpha1ApiFp(this.configuration).getSnapshotForPost(requestParameters.name, requestParameters.postName, requestParameters.patched, options).then((request) => request(this.axios, this.basePath));
    }
}
