...
export const AttachmentV1alpha1ApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async createAttachmentForPost(file: File, waitForPermalink?: boolean, postName?: string, singlePageName?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Attachment>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['AttachmentV1alpha1Api.createAttachmentForPost']?.[localVarOperationServerIndex]?.url;
...
export const AttachmentV1alpha1ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        /**
         * Create attachment for the given post.
         * @param {AttachmentV1alpha1ApiCreateAttachmentForPostRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        createAttachmentForPost(requestParameters: AttachmentV1alpha1ApiCreateAttachmentForPostRequest, options?: RawAxiosRequestConfig): AxiosPromise<Attachment> {
...
/**
 * Request parameters for createAttachmentForPost operation in AttachmentV1alpha1Api.
 * @export
 * @interface AttachmentV1alpha1ApiCreateAttachmentForPostRequest
 */
export interface AttachmentV1alpha1ApiCreateAttachmentForPostRequest {
    /**
     * 
     * @type {File}
     * @memberof AttachmentV1alpha1ApiCreateAttachmentForPost
     */
    readonly file: File
...
export class AttachmentV1alpha1Api extends BaseAPI {
     ...
     */
    public createAttachmentForPost(requestParameters: AttachmentV1alpha1ApiCreateAttachmentForPostRequest, options?: RawAxiosRequestConfig) {
        return AttachmentV1alpha1ApiFp(this.configuration).createAttachmentForPost(requestParameters.file, requestParameters.waitForPermalink, requestParameters.postName, requestParameters.singlePageName, options).then((request) => request(this.axios, this.basePath));
    }
}
