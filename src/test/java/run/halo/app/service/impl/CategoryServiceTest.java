    ...
    void listToTree() throws JsonProcessingException {
        ...
        assertEquals(
            "[{\"id\":1,\"name\":\"分类-1\",\"slug\":\"category1\",\"description\":null,"
                ...
                + "\"fullPath\":\"http://127.0.0.1:8090/categories/category1\",\"priority\":100,"
                ...
                + ".1:8090/categories/category2111\",\"priority\":100,\"children\":[]}]}]},"
                + "{\"id\":4,\"name\":\"分类-2-2\",\"slug\":\"category22\",\"description\":null,"
                + "\"thumbnail\":null,\"parentId\":2,\"password\":null,\"createTime\":null,"
                + "\"fullPath\":\"http://127.0.0.1:8090/categories/category22\",\"priority\":100,"
                + "\"children\":[]}]}]",
