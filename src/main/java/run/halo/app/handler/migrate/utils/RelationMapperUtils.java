...
public class RelationMapperUtils {
    public static <SOURCE, TARGET> TARGET convertFrom(SOURCE source, Class<TARGET> targetClazz) {
        ...
        return propertyMapper(source, target);
    }

    private static <SOURCE, TARGET> TARGET propertyMapper(SOURCE source, TARGET target) {
        ...
        for (Field sourceField : sourceFields) {
            ...
            if (sourceFieldHasAnnotation) {
                ...
                copyProperty(sourceFieldName, targetFieldName, source, target, sourceField.getType());
            } else {
    ...
    private static<SOURCE, TARGET> void copyProperty(String sourceFieldName, String targetFieldName, SOURCE source, TARGET target, Class<?> sourceType) {
        try {
            Class<?> sourceClazz = source.getClass();
