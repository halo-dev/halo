...
public interface Converter<SOURCE, TARGET> {
     ...
     */
    default TARGET converterFrom(SOURCE s, Function<SOURCE, TARGET> function) {
    ...
    default List<TARGET> batchConverterFromDto(List<SOURCE> list, Function<SOURCE, TARGET> function) {
        return list.stream().map(s -> converterFrom(s, function)).collect(Collectors.toList());
    }
}
