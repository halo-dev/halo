...
/**
 * <p>PluginManager to hold the main ApplicationContext.
 * It provides methods for managing the plugin lifecycle.</p>
 * Note that it is a thread unsafe class.
 *
 * @author guqing
 * @since 2.0.0
 */
@Slf4j
class UnSafePluginManager extends DefaultPluginManager
    ...
    public UnSafePluginManager() {
        super();
    }

    public UnSafePluginManager(Path pluginsRoot) {
        super(pluginsRoot);
    }
