...
/**
 * The {@link CategoryRouterStrategy} for generate {@link RouterFunction} specific to the template
 * <code>category.html</code>.
 *
 * @author guqing
 * @since 2.0.0
 */
public class CategoryRouterStrategy implements TemplateRouterStrategy {

    private final PermalinkIndexer permalinkIndexer;

    public CategoryRouterStrategy(PermalinkIndexer permalinkIndexer) {
