...
<@layout title="标签：${tag.name} | ${options.blog_title!'Material'}" keywords="${options.seo_keywords!'Material'}}" description="${options.seo_desc!'Material'}}">
    <!-- Index Module -->
    <div class="material-index mdl-grid">
        ...
        <@nav url="${options.blog_url!}/tags/${tag.slugName}/"></@nav>
        <#if (options.theme_material_scheme!'Paradox') == "Paradox">
