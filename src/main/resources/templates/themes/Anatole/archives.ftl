<!DOCTYPE html>
<!-- saved from url=(0033)https://www.isthnew.com/archives/ -->
<html lang="zh-CN">
...
<head>
    ...
    <title>归档 · ${options.site_title}</title>
    <meta name="description" content="归档页面 - 可乐没气的猫">
...
<div class="main">
    <div class="page-top animated fadeInDown">
        <div class="nav">
            ...
            <li>
                <a class="current" href="/archives">归档</a>
            </li>
            <li>
                <a href="/links">友链</a>
            </li>
                                    ...
                                    <#list archive.posts as post>
                                        <div class="listing-item">
                                            <div class="listing-post">
                                                <a href="/article/${post.postUrl}" title="${post.postTitle}">${post.postTitle}</a>
                                                <div class="post-time">
                                                    <span class="date">${post.postDate?string("MM-dd")}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </#list>
