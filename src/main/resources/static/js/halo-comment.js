...
// CONCATENATED MODULE: ./src/components/Comment.vue?vue&type=template&id=03f2374a&shadow
...
// CONCATENATED MODULE: ./node_modules/_cache-loader@2.0.1@cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"0baef6aa-vue-loader-template"}!./node_modules/_vue-loader@15.7.0@vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/_cache-loader@2.0.1@cache-loader/dist/cjs.js??ref--0-0!./node_modules/_vue-loader@15.7.0@vue-loader/lib??vue-loader-options!./src/components/CommentTree.vue?vue&type=template&id=63a6678a&
var CommentTreevue_type_template_id_63a6678a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[(_vm.comment)?_c('comment-node',[_c('figure',{staticClass:"avatar avatar-lg",attrs:{"slot":"comment-icon"},slot:"comment-icon"},[_c('img',{attrs:{"src":_vm.avatar,"alt":_vm.comment.author}})]),_c('p',{staticClass:"comment-author-wrapper",attrs:{"slot":"comment-title"},slot:"comment-title"},[_c('span',{staticClass:"comment-author"},[_vm._v(_vm._s(_vm.comment.author))]),_c('span',{staticClass:"comment-author-time m-2"},[_vm._v(_vm._s(_vm.createTimeAgo)+" ago")])]),_c('p',{staticClass:"comment-content-wrapper",attrs:{"slot":"comment-content"},domProps:{"innerHTML":_vm._s(_vm.compileContent)},slot:"comment-content"}),_c('template',{slot:"comment-action-bottom"},[_c('p',[_c('button',{staticClass:"btn btn-sm btn-link",on:{"click":_vm.handleReplyClick}},[_vm._v("回复")])])]),(_vm.comment.children)?_vm._l((_vm.comment.children),function(child,index){return _c('comment-tree',{key:index,attrs:{"slot":"comment-inner","comment":child},on:{"reply":_vm.handleSubReply},slot:"comment-inner"})}):_vm._e()],2):_vm._e()],1)}
var CommentTreevue_type_template_id_63a6678a_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/CommentTree.vue?vue&type=template&id=63a6678a&
...
var CommentTree_component = normalizeComponent(
  ...
  CommentTreevue_type_template_id_63a6678a_render,
  CommentTreevue_type_template_id_63a6678a_staticRenderFns,
  false,
  ...
  methods: {
    ...
    loadComments() {
      switch (this.type) {
        ...
        case 'sheet':
          apis_comment.listSheetComment(this.id, this.pagination, 'tree_view').then(response => {
            this.comments = response.data.data.content;
            this.pagination.total = response.data.data.total;
            this.pagination.rpp = response.data.data.rpp;
          });
        ...
        case 'journal':
          apis_comment.listJournalComment(this.id, this.pagination, 'tree_view').then(response => {
            this.comments = response.data.data.content;
            this.pagination.total = response.data.data.total;
            this.pagination.rpp = response.data.data.rpp;
          });
